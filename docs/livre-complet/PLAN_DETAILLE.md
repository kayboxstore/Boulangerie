...
Voir découpage détaillé dans `TABLE_DES_MATIERES.md`. 9 sous-chapitres rédigés à ce jour (22a Premiers pas, 22b Rôles et permissions, 22c Commandes et Clients, 22d Production, 22e Stocks et Fournisseurs, 22f Caisse, 22g Commissions, 22h Travailleurs et Paie, 22i Équipe et Approbations) sur 12 prévus (22a-22l).
